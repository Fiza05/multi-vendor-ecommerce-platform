...
public class GlobleException {
	...
	public ResponseEntity<ErrorDetails> CartItemExceptionHandler(CartItemException ue,
			WebRequest req) {
	...
	public ResponseEntity<ErrorDetails> CouponNotValidExceptionHandler(CouponNotValidException ue,
			WebRequest req) {
	...
	public ResponseEntity<ErrorDetails> methodArgumentNotValidExceptionHandler(
		...
		ErrorDetails err =
				new ErrorDetails(me.getBindingResult().getFieldError().getDefaultMessage(),
	...
	public ResponseEntity<ErrorDetails> otherExceptionHandler(Exception e, WebRequest req) {
		ErrorDetails error =
				new ErrorDetails(e.getMessage(), req.getDescription(false), LocalDateTime.now());
