...
import com.fiza.ecommerce_multivendor.exception.*;
...
public class ProductController {
    ...
    public ResponseEntity<Page<Product>> getAllProducts(
        ...
        return new ResponseEntity<>(productService.getAllProduct(category, brand, color, size,
                minPrice, maxPrice, minDiscount, sort, stock, pageNumber), HttpStatus.OK);
    }
}
